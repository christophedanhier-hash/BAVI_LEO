...
Le cron `Collecte Viessmann` reste désactivé (`enabled: false`). Dernière collecte : 15/07/2026 à 06:12. Aucun nouveau token régénéré — décision Christophe maintenue.
