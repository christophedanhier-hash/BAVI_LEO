...
> Source : `profiles/leo-copilot/cron/jobs.json` (26 jobs)
<!-- AUTO:END header -->
...
| Catégorie | Total |
|-----------|:-----:|
| **Crons Hermes** (tous profils, consolidé) | **26** |
...
| 17 | 🔄 Refresh Google Tokens (50min) | `*/50 * * * *` | script | ✅ |
| 18 | 🔄 drive-sync | `0 * * * *` | script | ✅ |
| 19 | 🔄 sync-skills-to-copilot | `*/30 * * * *` | script | ✅ |
| 20 | 🔍 Veille IA quotidienne | `0 7 * * *` | script | ✅ |
| 21 | 🔧 LEO Maintenance quotidienne | `0 3 * * *` | script | ✅ |
| 22 | 🚀 Deploy Unified Dashboard | `10 * * * *` | script | ✅ |
| 23 | 🛡️ Cron Ownership Watchdog | `5,20,35,50 * * * *` | script | ✅ |
| 24 | 🛡️ LEO Health Check (script) | `2,17,32,47 * * * *` | script | ✅ |
| 25 | 🩺 Cron Health Watchdog (log scanner) | `3,18,33,48 * * * *` | script | ✅ |
| 26 | 🩺 GitHub Actions Watchdog | `4,19,34,49 * * * *` | script | ✅ |
...
_Généré automatiquement le 09/07/2026 à 00:00_