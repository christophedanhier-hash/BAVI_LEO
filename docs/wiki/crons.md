...
| 2 | ⚡ Énergie — HomeWizard P1 | `*/2 * * * *` | script | ✅ |
| 3 | 💰 Budget Alert | `0 8,20 * * *` | script | ✅ |
| 4 | 💾 LEO Backup quotidien → GDrive (script) | `0 6 * * *` | script | ✅ |
| 5 | 💾 Recovery State Export → GDrive (horaire) | `30 * * * *` | script | ✅ |
| 6 | 📊 Synthèse Hebdomadaire LEO | `0 20 * * 0` | script | ⚠️ |
| 7 | 📊 Unified Collector v2 | `*/15 * * * *` | LLM | ✅ |
| 8 | 📋 Doc Watch Auto (sync documents) | `*/2 * * * *` | script | ✅ |
| 9 | 📋 doc-crons-sync | `0 */6 * * *` | script | ✅ |
| 10 | 📓 vault-bavi-daily-journal | `10 23 * * *` | LLM | ✅ |
| 11 | 📓 vault-daily-journal (vault-leo-copilot) | `0 23 * * *` | LLM | ✅ |
| 12 | 📓 vault-default-daily-journal | `5 23 * * *` | LLM | ✅ |
| 13 | 📓 vault-emile-daily-journal | `15 23 * * *` | LLM | ✅ |
| 14 | 📝 docs-update | `0 */4 * * *` | script | ✅ |
| 15 | 📡 Machine KPI Collector | `*/5 * * * *` | script | ✅ |
| 16 | 📦 Auto-Archive BAVI LEO (5min) | `every 5m` | script | ✅ |
| 17 | 📧 Email Classifier — rule-based (inbox zero) | `*/30 * * * *` | script | ✅ |
| 18 | 📷 Surveillance caméras — mouvement → Telegram | `*/5 * * * *` | script | ✅ |
| 19 | 🔄 Auto-commit wikis (toutes les heures) | `0 * * * *` | script | ✅ |
| 20 | 🔄 Dashboard LEO Watchdog (port 8765) | `*/2 * * * *` | script | ✅ |
| 21 | 🔄 Déploiement auto tofdan.be | `5 * * * *` | script | ✅ |
| 22 | 🔄 Gateway Auto-Restart | `*/15 * * * *` | script | ✅ |
| 23 | 🔄 Hermes Dashboard Watchdog (port 9119) | `*/2 * * * *` | script | ✅ |
...
| 31 | 🛡️ BAVI Server Watchdog | `*/5 * * * *` | script | ✅ |
| 32 | 🛡️ Cron Ownership Watchdog | `5,20,35,50 * * * *` | script | ✅ |
| 33 | 🛡️ LEO Health Check (script) | `2,17,32,47 * * * *` | script | ✅ |
| 34 | 🛡️ Watchdog BAVI-LEO (Sylvia) | `*/5 * * * *` | script | ✅ |
| 35 | 🩺 Cron Health Watchdog (log scanner) | `3,18,33,48 * * * *` | script | ✅ |
...
_Généré automatiquement le 12/07/2026 à 18:00_