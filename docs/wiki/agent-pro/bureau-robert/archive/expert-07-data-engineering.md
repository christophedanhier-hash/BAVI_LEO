...
expert: 07-data-engineering
version: v1
type: fiche-expert
statut: finalise
tags: [fiche-expert, data, mlops, rag, llm, solidaris, pro]
---
...
- MLOps, RAG, embeddings, bases vectorielles
...
| Expert | Raison |
|:-------|:-------|
| Data Analyse (16) | Gouvernance données |
| Infra IA (8) | Infrastructure déploiement |
| API IA (9) | Intégration API LLM |

## ⚠️ Pitfalls
- Données médicales : pseudonymisation obligatoire
