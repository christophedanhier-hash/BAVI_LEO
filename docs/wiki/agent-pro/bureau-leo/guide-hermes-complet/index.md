...
- **Partie IV — La Puissance des Skills** : exploiter 130+ skills prêts à l'emploi et créer les vôtres
- **Partie V — Dashboards et Monitoring** : visualiser tout avec 1 dashboard central (4 onglets), audit rédactionnel automatisé
- **Partie VI — Automatisation et Crons** : faire tourner 38 crons Hermes + 6 crons hôte sans lever le petit doigt
...
**Projet vivant** — dernière mise à jour : 18 juillet 2026. Hermes Agent évolue vite, ce guide aussi.
...
- **[Ch.8 — Skills : le super-pouvoir d'Hermès](02-configurer/ch08-skills.md)**
  ...
  - Les 130+ skills de LEO : classification et navigation
...
- **[Ch.15 — Les autres bureaux](03-bureaux-bavi/ch15-autres-bureaux.md)**
  ...
  - Bureau Connaissance : la bibliothèque centralisée
