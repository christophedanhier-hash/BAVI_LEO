...
auteur: LEO
version: v3.0
tags: [leo, velo, electrique, pliable, etude-marche, engwe, achat, o20-boost, l20-boost, zip, p275]
statut: ✅ Complete
type: etude
---
...
Achat de **2 velos electriques pliables** pour usage personnel/couple.
Recherche : rapides, pliables, bon rapport qualite-prix, marque ENGWE.
...
| **Couple max** | **75 Nm** avec bouton Boost |
| **Batterie** | **LG 720 Wh** avec BMS (protection intelligente) |
| **Autonomie PAS 1** | **141 km** |
| **Autonomie PAS 3** | 108 km |
| **Autonomie PAS 5** | 80 km |
| **Chargeur** | **4A fast charger** — charge complete **3,5h** (supporte 8A optionnel) |
| **Batterie amovible** | ✅ Oui, portable |
| **Transmission** | **Shimano 8 vitesses** |
| **Freins** | Freins a disques mecaniques |
| **Suspension** | Fourche avant **50 mm** |
| **Pneus** | 2.125" anti-crevaison (puncture-resistant) |
| **Poids** | **26,5 kg** |
| **Charge utile max** | **150 kg** |
| **Pliant** | ✅ Oui, pliage rapide une main |
| **Assistance** | 5 niveaux (PAS 1-5) |
| **Vitesse max** | 25 km/h (norme UE) |
| **Etancite** | IPX7 (cables) / IPX6 (ecran + lumieres) / IPX5 (moteur + controleur) / IPX4 (batterie) |
| **Antivol** | **Mtag** — traceur integre iOS/Android (emplacement cache) |
| **Certification** | CE EN15194 — TUV |
| **Ecran** | LCD couleur |
| **Eclairage avant** | Feu avant puissant |
| **Eclairage arriere** | Feux arriere + feux de freinage |
| **Béquille** | **Bequille double** (2 pieds) pour stationnement stable |
| **Terrain** | Routes, chemins gravel, plage, chemins de campagne |
| **Coloris** | Graphite Gray, Dusty Blue, Soft Purple |

#### Contenu de la boite (par velo)

- Velos electrique O20 Boost
- Batterie LG 720Wh
- Chargeur rapide 4A
- Outils de montage
- Pedales
...
#### Accessoires OFFERTS avec le velo (jusqu'a €137.90 d'economie)

| Accessoire | Prix normal | Offert |
|:-----------|:-----------:|:------:|
| 🔒 Folding Bike Lock | €59.00 | ✅ Gratuit |
| 📍 ENGWE Bike Tracker (Mtag) | €19.90 | ✅ Inclus dans la boite |
| 🧳 Porte-bagages arriere | €59.00 | ✅ Inclus dans la boite |

#### Option batterie supplementaire

> La batterie LG 720Wh est amovible et portable.
> Une **seconde batterie** permet de doubler l'autonomie ou de charger une pendant que l'autre est utilisee.
> Compatible avec le chargeur rapide 4A (ou 8A optionnel).

| Option batterie | Estimation prix |
|:----------------|:--------------:|
| Batterie O20 720Wh supplementaire | ~**€299** (estimation, similaire aux autres batteries ENGWE) |
| Chargeur rapide 8A optionnel | ~**€50** (charge en ~1h45 au lieu de 3h30) |

#### Avis clients

- **Note :** 5.00/5 — **13 avis**
- Points forts : leger (26.5kg), puissant (75Nm), batterie 720Wh, pliage compact, rapport qualite-prix
- Avis typiques : "parfait pour les couples", "prend peu de place", "livraison rapide"
...
**Particularites :**
- 2 velos O20 Boost dans un seul achat
- Economie : **€50** vs achat de 2 seuls (€2,198)
- Choix des coloris : **Couleur 1** + **Couleur 2** (Soft Purple, Graphite Gray, Dusty Blue)
- Code promo **NEWENGWE** : -2% → **€2,105.04**
- Statut : Pre-sale (retour en stock fin juillet 2026)

---

## 3. Tous les modeles de la gamme ENGWE
...
|:-----|:---------:|:---------:|
| Poids | **26,5 kg** 🟢 | 34 kg |
| Batterie | **720 Wh LG** 🟢 | 624 Wh |
| Autonomie | **141 km** 🟢 | 126 km |
| Charge | **3,5h (4A)** 🟢 | 6,5h |
| Vitesses | **Shimano 8** 🟢 | Shimano 7 |
...
- Economie €50 vs achat solo
- Coloris disponibles : Vert, Noir
...
- Pas de bouton Boost
- Autonomie : 140 km PAS / 75 km pleine vitesse

### 3.6 ENGWE Zip

**Lien :** https://fr.engwe.com/products/engwe-zip
**Prix :** **€1,099.00** (NOUVEAUTE)

| Spec | Valeur |
|:-----|:-------|
| Poids | **~22 kg** (tres leger) |
| Pliage | **3 secondes** (brevet ENGWE) |
| Batterie | LG **360 Wh** avec **Power Bank USB-C PD 100W** |
| Autonomie | Jusqu'a **120 km** |
| Capteur | Torque sensor |
| Suspension | Tige de selle suspendue |
| Coloris | Gris, Vert Olive |

### 3.7 ENGWE P275 SE

**Prix :** **€899.00** (au lieu de €1,499 — **-40%**)
- Urbain tout temps, 250W couple, 100 km autonomie
- Ideal pour budget serre, pas besoin de fat tires

### 3.8 ENGWE P275 SE Combo

**Prix :** **€1,748.00** (au lieu de €2,998 — **-€1,250 !**)
- 2 velos urbains, le combo le plus economique

### 3.9 ENGWE L20 3.0 Pro

**Prix :** **€1,699.00** (au lieu de €1,799 — -€100)
| Spec | Valeur |
|:-----|:-------|
| Moteur | **Moteur central 250W** |
| Couple | **100 Nm** |
...
### Pourquoi le O20 Boost Combo est le meilleur choix

| Critere | Note | Commentaire |
|:--------|:----:|:------------|
| Prix | 🟢 | **€1,074/velo** (le moins cher des fat-style) |
| Poids | 🟢 | **26,5 kg** — facile a porter plie |
| Autonomie | 🟢 | **141 km** — record de la gamme |
| Batterie | 🟢 | **720 Wh LG** — la plus grosse de la gamme |
| Charge | 🟢 | **3,5h** — 2x plus rapide que L20 |
| Puissance | 🟢 | 75 Nm + Boost |
| Securite | 🟢 | **Mtag** antivol + freins disque |
| Polyvalence | 🟢 | Ville + chemins + plage |
| Pliant | 🟢 | Pliage rapide, 2 dans un coffre |
| Charge max | 🟢 | **150 kg** — meme pour 2 personnes +

### Points forts vs L20 Boost

| O20 Boost | VS | L20 Boost |
|:----------|:--:|:----------|
| ✅ 26,5 kg | **+7,5 kg plus leger** | 34 kg |
| ✅ 720 Wh LG | **+96 Wh** | 624 Wh |
| ✅ 141 km | **+15 km** | 126 km |
| ✅ 3,5h charge | **-3h** | 6,5h |
| ✅ Shimano 8 | **+1 vitesse** | Shimano 7 |
| ✅ 150 kg | **+30 kg** | 120 kg |
| ✅ Mtag antivol | **Inclus** | ❌ |
| ✅ €1,099 | **-€50** | €1,149 |
| ✅ Accessoires offerts | **3** | 2 |
| ❌ Pneus 2.125" | **Moins large** | Fat 4.0" 🟢 |

### Points d'attention

1. **Pneus** : 2.125" au lieu de Fat 4.0" → moins de grip sur sable/neige profonde
2. **Pre-sale** : retour en stock fin juillet 2026
3. **Batterie O20** : pas encore de batterie supplementaire listee sur le site
4. **Freins** : mecaniques (pas hydrauliques)

---

## 6. Budget total — Option recommandee

### Option A : O20 Boost Combo + batteries supplementaires 🏆

| Poste | Quantite | Prix unitaire | Total |
|:------|:--------:|:-------------:|:-----:|
| O20 Boost Combo (2 velos) | 1 | €2,148.00 | €2,148.00 |
| Batterie 720Wh supplementaire velo 1 | 1 | ~€299.00 | ~€299.00 |
| Batterie 720Wh supplementaire velo 2 | 1 | ~€299.00 | ~€299.00 |
| Chargeur rapide 8A optionnel | 1 | ~€50.00 | ~€50.00 |
| Code promo NEWENGWE **-2%** | — | — | **-€55.92** |
| **Total** | | | **~€2,740.08** |

### Option B : O20 Boost Combo seul (sans batterie supplementaire)

| Poste | Total |
|:------|:-----:|
| O20 Boost Combo | €2,148.00 |
| Code NEWENGWE -2% | -€42.96 |
| **Total** | **€2,105.04** |
...
- https://engwe.com/products/engwe-o20-boost
- https://engwe.com/products/engwe-o20-boost-combo
- https://fr.engwe.com/products/l20-boost
- https://fr.engwe.com/products/l20-boost-combo
- https://fr.engwe.com/products/engwe-zip
